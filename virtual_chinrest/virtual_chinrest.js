...
*/
            ...
            {
                $('#info-p').append("You are too away from the screen. Please shift a your seat closer to the screen and try again. Alternatively, please measure 50 cm in between yourself and the screen, if possible, and start the test again.");
                $('#click').text(Math.max(5, 0));
                $("#start").attr("disabled", false); 
            }
